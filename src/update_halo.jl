...
Update the halo of the given GPU/CPU-array(s) following the currently active global grid specification or an explicitly passed global grid. Optionally a global grid specification can be passed, overriding the currently active grid.
